...
/**
 * Each mark is its owner's trademark, drawn to name the application a plugin
 * runs in and nothing else; the footer states that this project is independent
 * of all of them. The Obsidian and JetBrains outlines come from Simple Icons
 * under CC0-1.0 and the Visual Studio Code outline from Devicon under MIT —
 * those licences cover the drawing, never the mark.
 */
const MARKS: Partial<Record<SitePath, { viewBox: string; d: string }>> = {
  [PATHS.vscode]: {
    viewBox: "0 0 128 128",
...
/**
 * Monochrome, because a brand colour would have to answer to both themes and
 * JetBrains' own is black. The shape is what a reader recognises.
 */
export function PlaceMark({
  ...
  if (place === PATHS.editor) {
    return (
      <img src="/favicon.svg" alt="" data-mark={place} className={className} />
    );
  }
